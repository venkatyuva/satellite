 ...
 * */
@Component
public class UpdateCustomerSatelliteValidator implements BaseEntityValidator {
    ...
    public void validate(BaseEntity baseEntity) throws Exception {
        ...
        if (customerSatelliteOptional.isEmpty()) {
            throw new EntityNotFoundException("Customer Satellite " + customerSatellite.getId() +
                    " is not available");
        }
